...
const providers = [
  {
    ...
    verified: true,
    about: "Professional with 5+ years of experience in Consulting services.",
  },
  {
    id: 2,
    name: "Vipina K C",
    ...
    location: "Canberra, ACT",
    verified: true,
    about: "Certified Assistant Nurse with 6+ years of experience in the industry.",
  },
  {
    id: 3,
    name: "Soni Shrestha",
    ...
    location: "Canberra, ACT",
    verified: true,
    about: "Conflict resolution officer with 7+ years of experience.",
  },
  {
    id: 4,
    name: "Smriti Sharma",
    ...
    location: "Sydney, NSW",
    verified: true,
    about: "Office Manager with 7+ years of experience",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 112,
    location: "Canberra and surroundings, ACT, NSW",
    verified: true,
    about: "Support Coordinator for NDIS participants.",
  },
];
